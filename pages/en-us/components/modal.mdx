...
<Note>
  ...
  <NextLink href="/en-us/components/toast">
    <Link color>Toast component</Link>
  </NextLink>
  .
</Note>
  ...
  return (
    <div>
      ...
      <Modal open={state} onClose={closeHandler}>
        ...
        <Modal.Action onClick={() => setState(false)}>Cancel</Modal.Action>
        <Modal.Action type="secondary">Submit</Modal.Action>
        <Modal.Action type="success">Submit</Modal.Action>
        <Modal.Action type="warning">Submit</Modal.Action>
        <Modal.Action type="error">Submit</Modal.Action>
      </Modal>
    </div>
  )
}
...
| Attribute    | Description            | Type                                                   | Accepted values           | Default   |
| ------------ | ---------------------- | ------------------------------------------------------ | ------------------------- | --------- |
| **type**     | current type           | `NormalTypes`                                          | [ActionType](#actiontype) | `default` |
...
<Attributes.Title>ActionType</Attributes.Title>

```ts
type ActionType = 'default' | 'secondary' | 'success' | 'warning' | 'error'
```
